 ...
 *
 * These cases pin the DTO shape itself rather than the service, because the
 * fix lives in the pipe: the field has to be gone from the metatype so
...
describe('UpdateCustomerDto — link-once cannot be smuggled through PATCH', () => {
  ...
  it('rejects ownerSalesRepId on update, as it already did', () => {
